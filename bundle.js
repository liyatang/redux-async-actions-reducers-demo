...
/******/ 	__webpack_require__.p = "/redux-async-actions-reducers-demo/";
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'h1',
	                    null,
	                    'Demo redux-async-actions-reducers'
	                ),
	                ...
	                _react2.default.createElement('hr', null),
	                _react2.default.cloneElement(this.props.children, Object.assign({
	...
	var ConnectApp = (0, _reactRedux.connect)(function (state) {
	    ...
	    return {
	        actions: (0, _reduxAsyncActionsReducers.bindAsyncActions)(_actions2.default, dispatch)
	    };
	})(App);

	var A = function A(location, cb) {
	    __webpack_require__.e/* nsure */(1, function () {
	        cb(null, __webpack_require__(256).default);
	    });
	};

	var B = function B(location, cb) {
	...
	var Root = _react2.default.createElement(
	    ...
	    { store: (0, _reduxAsyncActionsReducers.createStore)(_reducers2.default) },
	    _react2.default.createElement(
	        _reactRouter.Router,
	        { history: _reactRouter.hashHistory },
	        _react2.default.createElement(
	            _reactRouter.Route,
	            { path: '/', component: ConnectApp },
	            _react2.default.createElement(_reactRouter.IndexRoute, { component: Home }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'a', getComponent: A }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'b', getComponent: B })
	        )
	    )
	);

	_reactDom2.default.render(Root, document.getElementById("appContainer"));
...
/***/ function(module, exports) {
	 ...
	 */
	var bindAsyncActions = function bindAsyncActions(actions, _dispatch) {
	    dispatch = _dispatch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = function global() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? globalInitState : arguments[0];
	    var action = arguments[1];

	    console.log(action.type);
	    switch (action.type) {
	        case _action2.default.GLOBAL_HELLO:
	...
	var rootReducer = (0, _reduxAsyncActionsReducers.combineAsyncReducers)(reducers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	actions.global_hello = function () {
	    return {
	        type: _action2.default.GLOBAL_HELLO,
	        name: 'i am global'
	    };
	};
